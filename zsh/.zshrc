...
# Order matters: env (exports, options) → theme (exports the appearance-dependent
# colours the other tools read at launch) → vi-mode (rebinds keymaps, so it must
...
for _f in env theme vi-mode aliases tools prompt plugins; do
