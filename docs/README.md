...
| **[working-with-agents.md](working-with-agents.md)** | **Work with agents as a skill** — the Frame→Delegate→Verify→Comprehend loop, who owns which phase, running many agents in worktrees without collisions, reading the diff, and re-prompting. |
